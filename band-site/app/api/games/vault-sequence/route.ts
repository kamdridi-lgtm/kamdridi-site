...
<div id="kamdridi-preview-lock">
  <div id="kamdridi-preview-card">
    <h2>Vault Preview Complete</h2>
    <p>Join the fan club or buy the Chapter II license to unlock the full Vault Sequence build.</p>
    <div id="kamdridi-preview-actions">
      <a href="/fan-club#membership" target="_top" rel="noreferrer">Unlock via Fan Club</a>
      <a href="/store#vault-sequence-license" target="_top" rel="noreferrer" class="secondary">Buy Chapter II</a>
    </div>
  </div>
</div>
<script>
...
<head>
  ...
  <title>Vault Sequence Access Locked</title>
  <style>
    body {
      margin: 0;
      min-height: 100vh;
...
<body>
  <div class="card">
    <h1>Access Locked</h1>
    <p>Open the preview from the game page, join the fan club, or buy the Chapter II license to unlock full access.</p>
  </div>
</body>
</html>`;
}
...
export async function GET(request: Request) {
  ...
  const filePath = path.join(process.cwd(), "content", "games", "vault-sequence-v1.html");
