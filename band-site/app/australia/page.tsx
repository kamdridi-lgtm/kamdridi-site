        ...
        <div className="relative z-10 mx-auto max-w-[1280px] border-x border-white/10 bg-black/20 shadow-[0_0_100px_rgba(0,0,0,.9)]">
          ...
          <div className="bg-black/[0.08] backdrop-blur-[1px]">
            ...
            <section id="edition" className="mx-auto max-w-6xl scroll-mt-40 px-5 pb-20 sm:px-8 md:pb-28">
              ...
              <figure className="mt-6 overflow-hidden rounded-[1.75rem] border border-[#e5d1aa]/30 bg-black/70 shadow-[0_28px_80px_rgba(0,0,0,.5)] backdrop-blur-[2px]">
                <div className="relative aspect-[16/9] overflow-hidden bg-black/80">
                  <Image
                    src="/australia/17-for-ever-booklet-spread.webp"
                    alt="17 FOR EVER collector booklet spread and archive artwork"
                    fill
                    sizes="(max-width: 768px) 100vw, 1152px"
                    className="object-contain transition duration-700 hover:scale-[1.01]"
                  />
                </div>
                <figcaption className="flex flex-col gap-1 border-t border-white/15 bg-black/80 px-5 py-4 sm:flex-row sm:items-end sm:justify-between sm:px-6">
                  <p className="text-sm font-black uppercase tracking-[0.18em] text-white">Collector Booklet</p>
                  <p className="text-xs uppercase tracking-[0.16em] text-stone-400">Archive spread · complete physical story</p>
                </figcaption>
              </figure>
