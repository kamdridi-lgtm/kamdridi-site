...
const de: TranslationDictionary = {
  ...
  scenes: {
    "master-manuscript": {
      ...
      eyebrow: "Das Quellenobjekt",
      description: "Unter versiegelten Papieren und vergessenen Katalogen wiedergefunden, betritt das Manuskript das Archiv als ein Objekt ohne Geschichte.",
      alt: "Das Hauptmanuskript von The Lost Requiem",
    },
    "discovery-provenance": {
      title: "HERKUNFT",
      eyebrow: "Auf den Spuren des Ursprungs",
      description: "",
      alt: "Details zur Herkunft des Manuskripts",
    },
    "restoration-lab-b": {
      title: "ANALYSE",
      eyebrow: "Authentifizierung",
      description: "Tinte, Papier, Siegel und Beschädigungen werden untersucht. Jede Markierung wird zum Beweis; jedes Schweigen wirft eine neue Frage auf.",
      alt: "Analyse des Manuskripts im Restaurierungslabor",
    },
    "restoration-lab-a": {
      title: "STABILISIERUNG",
      eyebrow: "Manuelle Restaurierung",
      description: "Das Manuskript wird stabilisiert, nicht neu gemacht. Seine Narben bleiben Teil des Objekts und seiner Geschichte.",
      alt: "Manuelle Restaurierung der Manuskriptseiten",
    },
    "secret-library": {
      title: "DAS ARCHIV",
      eyebrow: "Bewahrung",
      description: "Fernab der Öffentlichkeit aufbewahrt, wartet die Partitur zwischen von der Zeit verlassenen Werken.",
      alt: "Das Manuskript, aufbewahrt im Tresorraum einer geheimen Bibliothek",
    },
    "museum-case-hero": {
      title: "DIE AUSSTELLUNG",
      eyebrow: "Erstes Licht",
      description: "Zum ersten Mal verlässt das Manuskript das Archiv und tritt in das Licht der Galerie.",
      alt: "Hauptansicht des Manuskripts in einer Museumsvitrine",
    },
    "grand-gallery": {
      title: "GROSSE GALERIE",
      eyebrow: "Öffentliche Ausstellung",
      description: "",
      alt: "Das Manuskript, ausgestellt in der großen Galerie",
    },
    "museum-case-close": {
      title: "DETAILANSICHT",
      eyebrow: "Genaue Betrachtung",
      description: "",
      alt: "Nahansicht des Manuskripts in der Museumsvitrine",
    },
    "composers-desk": {
      title: "DER SCHREIBTISCH",
      eyebrow: "Genesis",
      description: "Vor dem Konzert gab es nur Papier, Tinte und die Möglichkeit von Klang.",
      alt: "Der Schreibtisch des Komponisten mit frühen Skizzen",
    },
    "piano-room": {
      title: "DER RAUM",
      eyebrow: "Erste Noten",
      description: "",
      alt: "Das Klavierzimmer, in dem die Komposition begann",
    },
    "fortepiano": {
      title: "DAS INSTRUMENT",
      eyebrow: "Genesis",
      description: "",
      alt: "Das historische Hammerklavier, das für die Komposition verwendet wurde",
    },
    "resurrection": {
      title: "WIEDERAUFERSTEHUNG",
      eyebrow: "Rückkehr zum Klang",
      description: "Das geschriebene Objekt wird zur Schwingung. Das Archiv weicht der Musik.",
      alt: "Platzhalter für das kommende Orchesterkonzert",
    },
  },
  audioGuide: {
    label: "Audioguide",
