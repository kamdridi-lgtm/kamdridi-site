  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
      <div className="grid gap-6">
        <GlassCard id="membership">
          <p className="text-xs uppercase tracking-[0.45em] text-[#f4c66a]">Membership</p>
          <h2 className="mt-4 font-display text-4xl uppercase tracking-[0.08em] text-white">
            Login or create an account
          </h2>
          <p className="mt-4 text-sm leading-7 text-stone-400">
            This project includes a local file-backed auth flow for development. Swap it for a
            database and real sessions when you move to production.
          </p>
          <form
