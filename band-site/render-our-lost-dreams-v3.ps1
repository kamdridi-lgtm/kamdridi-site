...
$variants = @(
    @{ vNum=1; ts='00:02:00'; img='C:\Users\Administrator\.gemini\antigravity\brain\0fa9401b-5e93-48ac-a7e7-11bfcf1770b3\.user_uploaded\media__1784635178900.jpg' },
...
"
    # Remove newlines for the command line argument
    $filter = $filter -replace "\r?\n", ""
    
    ffmpeg -y -loop 1 -framerate 30 -i $v.img -ss $v.ts -t 10 -i $audio -filter_complex $filter -map "[base]" -map 1:a -c:v libx264 -preset fast -crf 23 -c:a aac -b:a 192k -shortest $out
}
